...
public partial class WoodDBContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        optionsBuilder.UseSqlServer($"Data Source=(localdb)\\MSSQLLocalDB;Initial Catalog=wood;Connection Lifetime = 3;Integrated Security=True;Connect Timeout=10;Application Intent=ReadWrite;MultipleActiveResultSets=true;"); //D:\\code\\WoodWebAPI\\Database\\wood.mdf
    }      
}
